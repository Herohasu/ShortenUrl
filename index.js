...
const { connectDB } = require("../coolurl-master/db");
connectDB();

// Import Router
const mainRouter = require("../coolurl-master/routes/mainRouter");
const apiRouter = require("../coolurl-master/routes/apiRouter");
